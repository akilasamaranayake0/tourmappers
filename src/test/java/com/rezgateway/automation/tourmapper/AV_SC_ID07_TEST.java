...
public class AV_SC_ID07_TEST extends ExtentTestNGReportBuilderExt{
	...
	public synchronized void availbilityTest(String TestUrl) throws Exception {
		...
		result.setAttribute("Expected", "All the 25 hotels should availbile in the availbility Response ");
		...
		if (Response.getRESPONSE_CODE() == 200) {
			...
			if (AvailabilityResponse.getHotelCount() > 0) {
			    if(AvailabilityResponse.getHotelCount()==25){
	...
	public AvailabilityRequest getAvailabilityData() throws Exception {
		...
		AviRequest = loader.getReservationReqObjList(ExcelDataSingleton.getInstance("Resources/Full Regression Testing Checklist.xls", "Scenario").getDataHolder())[6][0];
		return AviRequest;
