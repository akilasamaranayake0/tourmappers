...
public class RES_SC_ID08_TEST extends ExtentTestNGReportBuilderExt {
	...
	public ReservationRequest getAvailabilityData() throws Exception {
		...
		ResRequest = loader.getReservationReqObjList(ExcelDataSingleton.getInstance("Resources/Full Regression Testing Checklist.xls", "Scenario").getDataHolder())[64][0];
		return ResRequest;
