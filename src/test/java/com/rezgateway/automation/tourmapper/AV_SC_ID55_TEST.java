...
public class AV_SC_ID55_TEST extends ExtentTestNGReportBuilderExt{
	...
	//Hotel id Search – Applying Promotions (Free Night , Discount , Value Added , Supplementary)
	...
	public AvailabilityRequest getAvailabilityData() throws Exception {
		...
		AviRequest = loader.getReservationReqObjList(ExcelDataSingleton.getInstance("Resources/Full Regression Testing Checklist.xls", "Scenario").getDataHolder())[54][0];
		return AviRequest;
