...
////Cancellation scenario Confirmed within cancellation period most restrictive policy 1

public class CNX_SC_ID05_TEST extends ExtentTestNGReportBuilderExt {
	...
	public synchronized void cancellationTesting(String TestUrlRes, String TestUrl, String TestUrlCnx) throws Exception {
		...
		//Within Cancellation period less than 10
		  DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd-MMM-yyyy");
		   ...
		   now= now.plusDays(45);//within cancel policy less than 50 days
	...
	try {
			if(("525").equals(cnxR.getCanellationFee())){
	...
	public ReservationRequest getAvailabilityData() throws Exception {
		...
		ResRequest = loader.getReservationReqObjList(ExcelDataSingleton.getInstance("Resources/Full Regression Testing Checklist.xls", "Scenario").getDataHolder())[69][0];
		return ResRequest;
