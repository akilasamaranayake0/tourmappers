...
public class AV_SC_ID54_TEST extends ExtentTestNGReportBuilderExt{
	...
	//Hotel id Search – Applying Promotions (Supplementary)
	...
	public AvailabilityRequest getAvailabilityData() throws Exception {
		...
		AviRequest = loader.getReservationReqObjList(ExcelDataSingleton.getInstance("Resources/Full Regression Testing Checklist.xls", "Scenario").getDataHolder())[53][0];
		return AviRequest;
