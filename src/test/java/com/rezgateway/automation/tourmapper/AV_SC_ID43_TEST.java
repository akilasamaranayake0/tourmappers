...
public class AV_SC_ID43_TEST extends ExtentTestNGReportBuilderExt{
	...
	public AvailabilityRequest getAvailabilityData() throws Exception {
		...
		AviRequest = loader.getReservationReqObjList(reader.getExcelData("Resources/Full Regression Testing Checklist.xls", "Scenario"))[42][0];
		return AviRequest;
