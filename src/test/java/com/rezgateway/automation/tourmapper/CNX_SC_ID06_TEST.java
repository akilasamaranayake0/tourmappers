...
////Cancellation scenario Confirmed within cancellation period most restrictive policy 2

public class CNX_SC_ID06_TEST extends ExtentTestNGReportBuilderExt {
	...
	public synchronized void cancellationTesting(String TestUrlRes, String TestUrl, String TestUrlCnx) throws Exception {
		...
		//Within Cancellation period less than 10
		  DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd-MMM-yyyy");
		   ...
		   now= now.plusDays(55);//within cancel policy less than 60 days
	...
	try {
			if(("419.2").equals(cnxR.getCanellationFee())){
