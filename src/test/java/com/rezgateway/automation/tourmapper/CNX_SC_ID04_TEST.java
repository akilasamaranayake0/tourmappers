...
//Cancellation scenario Request outside and within cancellation period

public class CNX_SC_ID04_TEST extends ExtentTestNGReportBuilderExt {
	...
	public ReservationRequest getAvailabilityData() throws Exception {
		...
		ResRequest = loader.getReservationReqObjList(ExcelDataSingleton.getInstance("Resources/Full Regression Testing Checklist.xls", "Scenario").getDataHolder())[68][0];
		return ResRequest;
