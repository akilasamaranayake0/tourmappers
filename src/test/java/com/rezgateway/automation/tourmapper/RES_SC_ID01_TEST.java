...
public class RES_SC_ID01_TEST extends ExtentTestNGReportBuilderExt {
	...
	public ReservationRequest getAvailabilityData() throws Exception {
		...
		ResRequest = loader.getReservationReqObjList(ExcelDataSingleton.getInstance("Resources/Full Regression Testing Checklist.xls", "Scenario").getDataHolder())[57][0];
		return ResRequest;
