...
public class AV_SC_ID14_TEST extends ExtentTestNGReportBuilderExt{
	...
	/*
	 * @Test( enabled = false) public synchronized void testHotelCode() {
	 * 
	 * ITestResult result = Reporter.getCurrentTestResult();
	...
	public AvailabilityRequest getAvailabilityData() throws Exception {
		...
		AviRequest = loader.getReservationReqObjList(ExcelDataSingleton.getInstance("Resources/Full Regression Testing Checklist.xls", "Scenario").getDataHolder())[13][0];
		return AviRequest;
